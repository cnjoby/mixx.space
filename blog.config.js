...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '蒋产品', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '搞AR/MR的', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mixx.space', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '文化,智能,计算,AR,MR,未来博物馆,文旅景区', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/images/starter/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '沪ICP备2023018343号', // 备案号 
