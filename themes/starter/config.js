...
const CONFIG = {
  ...
  // 英雄区配图，如需隐藏，改为空值即可 ''
  STARTER_HERO_PREVIEW_IMAGE: '/images/3641728722713_.pic_hd.jpg', // 产品预览图 ，默认读取public目录下图片
  STARTER_HERO_BANNER_IMAGE: '', // hero区下方的全宽图

  // 顶部右侧导航暗流
  STARTER_NAV_BUTTON_1_TEXT: '企业管理',
  STARTER_NAV_BUTTON_1_URL: 'https://managers.mixx.space/business/',
 STARTER_NAV_BUTTON_2_TEXT: '测试',
  STARTER_NAV_BUTTON_2_URL: 'https://managers.mixx.space/business/',
