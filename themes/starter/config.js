...
const CONFIG = {
  ...
  // 英雄区配图，如需隐藏，改为空值即可 ''
  STARTER_HERO_PREVIEW_IMAGE: 'images/3641728722713_.pic_hd.jpg', // images/3641728722713_.pic_hd.jpgimages/generated_image_2025-09-18_16-11-24_2.webp产品预览图 ，默认读取public目录下图片
  ...
  // 嵌入外部表单
  STARTER_CONTACT_MSG_EXTERNAL_URL: 'https://noteforms.com/forms/zdzoon', // 基于NoteForm创建，将留言数据存在Notion中
  //   自定义留言表单，以下几个配置暂时废弃
...
STARTER_FOOTER_PRIVACY_TERMS_OF_SERVICE_TEXT: '幂景科技（上海）有限公司 ©️2023-2025',
